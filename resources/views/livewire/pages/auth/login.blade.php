...
<div class="max-w-md mx-auto my-12">
    ...
    <div class="glass-card p-5 sm:p-8 rounded-3xl border border-theme-medium space-y-6 relative overflow-hidden animate-scale-in">
        ...
        <h2 class="text-xl font-bold text-theme text-center">{{ __('auth.login.heading') }}</h2>
        ...
        <form wire:submit="login" class="space-y-4">
            ...
            <div class="relative my-4">
                ...
                <div class="relative flex justify-center text-xs uppercase">
                    <span class="px-2 text-theme-secondary" style="background: var(--bg-glass-bg);">{{ __('auth.login.or') }}</span>
                </div>
            </div>
            ...
            <p class="text-xs text-center text-theme-muted">
                ...
                <a href="{{ route('register') }}" class="text-blue-400 hover:underline font-semibold" wire:navigate>{{ __('auth.login.register_link') }}</a>
            </p>
        </form>
    </div>
</div>

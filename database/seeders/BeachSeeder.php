...
class BeachSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $beaches = [
            ...
            ['name' => 'Praia de Vila Nova de Milfontes', 'slug' => 'praia-da-franquia-milfontes', 'district' => 'Beja', 'municipality' => 'Odemira', 'lat' => 37.7233, 'lon' => -8.7903, 'blue_flag' => true, 'accessible' => true, 'desc' => 'Praia da Franquia junto à foz do rio Mira.'],

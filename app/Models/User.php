...
#[Fillable(['name', 'email', 'password', 'username', 'google_id', 'avatar', 'score', 'confirmations_count', 'accepted_confirmations_count', 'penalized_confirmations_count', 'is_suspended', 'is_admin', 'referral_code', 'locale', 'default_region'])]
